...
def local_external_DNS_output(question_type, local_nameserver, nameserver):    
    print("Local DNS Server")
    for domain_name in domainList:
        ip_address = query_local_dns_server(domain_name, question_type, nameserver)
    ...
    for domain_name in domainList:
        ip_address = query_dns_server(domain_name, question_type, nameserver)
        print(f"The IP address of {domain_name} is {ip_address}")
